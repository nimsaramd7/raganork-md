...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'Nimsara-Md',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? 'NIMSARAMDBOT; Nimsara MD bot;https://hb4alllink.herokuapp.com/1aeea/file.jpg' : process.env.AUDIO_DATA,
